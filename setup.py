...
class BumpCommand(Command):
    ...
    def run(self):
        ...
        print("old version: %s  new version: %s" % (metadata["version"], self.version))
        try:
...
setup(
    ...
    install_requires=["pyyaml", "python-jenkins",],
    entry_points={"console_scripts": ["jjwrecker = jenkins_job_wrecker.cli:main",],},
    tests_require=["pytest", "jenkins-job-builder",],
    cmdclass={"bump": BumpCommand, "release": ReleaseCommand, "test": PyTest,},
)
